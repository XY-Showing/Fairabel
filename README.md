...
## Scripts and results
The repository contains the source code to replicate the Fairabel approach. 'Fairabel_cy.py' is the script to produce the raw results. The 'utility.py' and 'Measure.py' contain the methods used in the 'Fairabel_cy.py'.
...
```
cd 'your_path'
python Fairabel_cy.py -d adult -c lr -p sex
python Fairabel_cy.py -d adult -c rf -p sex
python Fairabel_cy.py -d adult -c svm -p sex

python Fairabel_cy.py -d adult -c lr -p race
python Fairabel_cy.py -d adult -c rf -p race
python Fairabel_cy.py -d adult -c svm -p race

python Fairabel_cy.py -d compas -c lr -p sex
python Fairabel_cy.py -d compas -c rf -p sex
python Fairabel_cy.py -d compas -c svm -p sex

python Fairabel_cy.py -d compas -c lr -p race
python Fairabel_cy.py -d compas -c rf -p race
python Fairabel_cy.py -d compas -c svm -p race

python Fairabel_cy.py -d default -c lr -p sex
python Fairabel_cy.py -d default -c rf -p sex
python Fairabel_cy.py -d default -c svm -p sex

python Fairabel_cy.py -d default -c lr -p age
python Fairabel_cy.py -d default -c rf -p age
python Fairabel_cy.py -d default -c svm -p age

python Fairabel_cy.py -d mep1 -c lr -p sex
python Fairabel_cy.py -d mep1 -c rf -p sex
python Fairabel_cy.py -d mep1 -c svm -p sex

python Fairabel_cy.py -d mep1 -c lr -p race
python Fairabel_cy.py -d mep1 -c rf -p race
python Fairabel_cy.py -d mep1 -c svm -p race

python Fairabel_cy.py -d mep2 -c lr -p race
python Fairabel_cy.py -d mep2 -c rf -p race
python Fairabel_cy.py -d mep2 -c svm -p race

python Fairabel_cy.py -d mep2 -c lr -p sex
python Fairabel_cy.py -d mep2 -c rf -p sex
python Fairabel_cy.py -d mep2 -c svm -p sex
```
